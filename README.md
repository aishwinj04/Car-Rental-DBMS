...
To run:
javac -cp ojdbc11.jar:. LoginPage.java

java -cp ojdbc11.jar:. LoginPage

Make sure to connect to the VPN before logging in.
After clicking login, it might take a while to load since the SQL file is being loaded.
